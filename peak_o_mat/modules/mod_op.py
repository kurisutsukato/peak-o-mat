...
trafomap = {'xrc_btn_A2eV': '12398.52/x',
            ...
            'xrc_btn_eV2cm': 'x*8065.478',
            'xrc_btn_cm2eV': 'x/8065.478'}
...
class XRCModule(module.XRCModule):
    ...
    def AAop_sgfilter(self, name, plot, sel):
    ...
    def AAop_splinesmooth(self, name, plot, sel):
    ...
    def AAop_average(self, name, plot, sel):
    ...
    def AAop_avg_sel(self, name, plot, sel):

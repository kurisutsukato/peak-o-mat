...
class PythonSTC(stc.StyledTextCtrl):
    ...
    def __init__(self, parent, ID,
        ...
        #self.StyleSetSpec(stc.STC_STYLE_BRACELIGHT,  "fore:#FFFFFF,back:#ccccFF")
        #self.StyleSetSpec(stc.STC_STYLE_BRACEBAD,    "fore:#000000,back:#FF0000")

...
class CalibrationModel(dv.DataViewIndexListModel):
    ...
    #element_map = dic([('Ne','neon'), ('Ar','argon'), ('Ne/Ar','near'), ('Hg','mercury'), ('Cd','cadmium'), ('Hg/Cad','merccad'), ('Custom',None)])
    conversion_map = dic([('eV','12398.52/standard'),('nm','standard/10.0'),("\u212B",'standard'),('cm-1','1.0/standard*1e8')])
...
class CalibGrid(dv.DataViewCtrl):
    def __init__(self, parent, model, **kwargs):
        ...
        self.col_standard = dv.DataViewColumn('standard', dv.DataViewTextRenderer(mode=dv.DATAVIEW_CELL_EDITABLE), 3, width=120)
